  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless scheduling with Doctor Appointment System, your one-stop solution for managing medical appointments. Simplifying healthcare, one booking at a time."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless scheduling with Doctor Appointment System, your one-stop solution for managing medical appointments. Simplifying healthcare, one booking at a time.`}
            </Text>
            <Box
